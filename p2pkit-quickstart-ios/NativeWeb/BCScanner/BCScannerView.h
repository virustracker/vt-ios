...
@protocol BCScannerViewDelegate;
...
/**
 BCScannerView is a view controller that wrapps the scanning
...
*/
@interface BCScannerView : UIView
 ...
 */
@property (nonatomic, weak, readwrite) id<BCScannerViewDelegate> delegate;
...
@protocol BCScannerViewDelegate <NSObject>
...
//- (void)scanner:(BCScannerView *)scanner codesDidUpdate:(NSSet *)codes;
