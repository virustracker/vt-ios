...
@interface BCScannerView () <AVCaptureMetadataOutputObjectsDelegate>
...
- (void)loadView
{
    self.view = [[BCVideoPreviewView alloc] initWithFrame:self.frame];
